...
def cross_validate_pipeline(p: common.Pipeline, *,
...
def f1_stats_from_pipeline_result(result: common.PipelineResult,
                                  average_mode: str) -> typing.Dict[step.PipelineStep, PrintableScores]:
...
def accumulate_pipeline_results(pipeline_results: typing.List[common.PipelineResult],
                                averaging_mode: str = 'micro') -> typing.Dict[step.PipelineStep, PrintableScores]:
    scores = []
...
def print_pipeline_results(p: common.Pipeline,
                           res: typing.Dict[step.PipelineStep, PrintableScores]):
