...
from augment.trafo103 import TagSubsequenceSubstition
...
def test_do_augment():
    # ARRANGE
    trafo1 = TagSubsequenceSubstition(num_of_words=2, prob=1, pos_tags=None)
    trafo2 = TagSubsequenceSubstition(
        num_of_words=3, prob=1, pos_tags=["NN", "IN", "DT", "NN"]
    )
    trafo3 = TagSubsequenceSubstition(num_of_words=3, prob=1, pos_tags=["NN", "IN"])
    ...
    tokens2 = [
        ...
        Token(
            text=",", index_in_document=9, pos_tag=",", bio_tag="O", sentence_index=1
        ),
        Token(
            text="I",
        ...
        Token(
            text="to", index_in_document=14, pos_tag="IN", bio_tag="O", sentence_index=1
        ),
        Token(
            text="the",
        ...
        Token(
            text=".", index_in_document=18, pos_tag=".", bio_tag="O", sentence_index=1
        ),
    ]
    ...
    # test1
    first_token1 = Token(
        text="Head", index_in_document=3, pos_tag="NN", bio_tag="O", sentence_index=0
    )
    first_token2 = Token(
        text="number",
        index_in_document=5,
