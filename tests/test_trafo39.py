import copy
from augment.trafo39 import EntityMentionReplacement
...
def test_do_augment():
    ...
    trafo1 = EntityMentionReplacement()

    # test1 - no entities (Parameters: mention_new = False)
    tokens1 = [
        Token(
            text="I", index_in_document=0, pos_tag="PRP", bio_tag="O", sentence_index=0
        ),
        Token(
            text="am", index_in_document=1, pos_tag="VBP", bio_tag="O", sentence_index=0
        ),
        Token(
        ...
        Token(
            text="of", index_in_document=4, pos_tag="IN", bio_tag="O", sentence_index=0
        ),
        Token(
    ...
    mentions2 = [
        Mention(ner_tag="Actor", sentence_index=0, token_indices=[1]),
        Mention(ner_tag="Actor", sentence_index=0, token_indices=[10]),
        Mention(ner_tag="Activity", sentence_index=0, token_indices=[3]),
        Mention(
            ner_tag="Activity Data", sentence_index=0, token_indices=[4, 5, 6, 7, 8]
        ),
    ...
    entities2 = [
        Entity(mention_indices=[0, 1, 2, 3, 4]),
        Entity(mention_indices=[5]),
        Entity(mention_indices=[6]),
        Entity(mention_indices=[7]),
        Entity(mention_indices=[8]),
        Entity(mention_indices=[9]),
        Entity(mention_indices=[10]),
        Entity(mention_indices=[11, 12, 13]),
        Entity(mention_indices=[14]),
        Entity(mention_indices=[15]),
        Entity(mention_indices=[16]),
        Entity(mention_indices=[17]),
        Entity(mention_indices=[18]),
        Entity(mention_indices=[19]),
    ]
    ...
    tokens3 = [
        ...
        Token(
            text="to", index_in_document=13, pos_tag="IN", bio_tag="O", sentence_index=0
        ),
        Token(
            text="the",
            index_in_document=14,
        ...
        Token(
            text=".", index_in_document=17, pos_tag=".", bio_tag="O", sentence_index=0
        ),
    ]
    ...
    mentions3 = [
        Mention(ner_tag="Actor", sentence_index=0, token_indices=[1, 2, 3]),
    ...
    entity_mentions_by_type_activity_data = [
        "a number of personnel requirements",
        "the vacancy",
    ]
    entity_mentions_by_type_activity_data2 = [
        "the vacancy",
        "a number of personnel requirements",
    ]

    mockito.when(trafo39).rand().thenReturn(0.2).thenReturn(1).thenReturn(
        0.2
    ).thenReturn(1).thenReturn(0.2).thenReturn(1).thenReturn(1)

    mockito.when(trafo39).choice(entity_mentions_by_type_actor).thenReturn(
        "the Personnel Department"
    )
    mockito.when(trafo39).choice(entity_mentions_by_type_actor2).thenReturn(
        "the Personnel Department"
    )
    mockito.when(trafo39).choice(entity_mentions_by_type_activity_data).thenReturn(
        "the vacancy"
    )
    mockito.when(trafo39).choice(entity_mentions_by_type_activity_data2).thenReturn(
        "the vacancy"
    )
    mockito.when(trafo39).choice(entity_mentions_by_type_activity).thenReturn(
        "detected"
    )
    mockito.when(trafo39).choice(entity_mentions_by_type_activity2).thenReturn(
        "detected"
    )
